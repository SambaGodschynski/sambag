 ...
 */
Tuple6 fromEndpointToCenter(Number x0, Number y0, Number x, Number y,
		Number rx, Number ry, Number phi, Number fA, Number fS) {
	...
	Number sq = ((rx_sq * ry_sq) - (rx_sq * y1_sq) - (ry_sq * x1_sq)) / ((rx_sq
			* y1_sq) + (ry_sq * x1_sq));
	sq = (sq < 0.0) ? 0.0 : sq;
