...
public:
	...
	//-------------------------------------------------------------------------
	virtual Number getCurrentFontHeight() const = 0;
	//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>Styling
	//-------------------------------------------------------------------------
	enum LineCapStyle {
		 NO_LINE_CAP = -1,
	...
	*/
    ...
    //-------------------------------------------------------------------------
    virtual void userToDevice(Point2D &inOut) = 0;
    //-------------------------------------------------------------------------
    virtual void deviceToUserDistance(Point2D &inOut) = 0;
    //-------------------------------------------------------------------------
    virtual void userToDeviceDistance(Point2D &inOut) = 0;
};
}} // namespaces
