...
IF(SAMBAG_LIBRARY_DIRS AND SAMBAG_INCLUDE_DIRS)
	...
	IF (WIN32)
		GET_FILENAME_COMPONENT(SAMBAG_LIB_RELEASE ${SAMBAG_LIBRARY_DIRS}/../Release/${LIBSAMBAG} REALPATH)
		GET_FILENAME_COMPONENT(SAMBAG_LIB_DEBUG ${SAMBAG_LIBRARY_DIRS}/../Debug/${LIBSAMBAGD} REALPATH)
		SET(SAMBAG_LIBRARIES ${SAMBAG_LIBRARIES} optimized ${SAMBAG_LIB_RELEASE})
		SET(SAMBAG_LIBRARIES ${SAMBAG_LIBRARIES} debug ${SAMBAG_LIB_DEBUG})
	ELSE(WIN32)
